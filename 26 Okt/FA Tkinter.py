...
ConfirmButton.pack()
Trein1 = Label(master=SecondFrame)
Trein2 = Label(master=SecondFrame)
Trein3 = Label(master=SecondFrame)
Trein4 = Label(master=SecondFrame)
Trein5 = Label(master=SecondFrame)
